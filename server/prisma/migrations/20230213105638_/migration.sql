/*
  ...
  - Added the required column `creatorId` to the `SubscriptionItem` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_SubscriptionItem" ("id", "productId", "quantity", "subscriptionId", "varientId") SELECT "id", "productId", "quantity", "subscriptionId", "varientId" FROM "SubscriptionItem";
