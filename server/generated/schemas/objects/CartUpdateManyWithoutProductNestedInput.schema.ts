...
const Schema: z.ZodType<Prisma.CartUpdateManyWithoutProductNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => CartUpsertWithWhereUniqueWithoutProductInputObjectSchema),
        z
          .lazy(() => CartUpsertWithWhereUniqueWithoutProductInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => CartUpdateWithWhereUniqueWithoutProductInputObjectSchema),
        z
          .lazy(() => CartUpdateWithWhereUniqueWithoutProductInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const CartUpdateManyWithoutProductNestedInputObjectSchema = Schema;
