...
const Schema: z.ZodType<Prisma.CartUncheckedCreateNestedManyWithoutVarientInput> =
  z
    .object({
      create: z
        .union([
...
export const CartUncheckedCreateNestedManyWithoutVarientInputObjectSchema =
  Schema;
