...
const Schema: z.ZodType<Prisma.UserAddressUpdateOneWithoutUserAddressNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserAddressUpdateOneWithoutUserAddressNestedInputObjectSchema =
  Schema;
