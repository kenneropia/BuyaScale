...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateNestedManyWithoutCreatorInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductUncheckedCreateNestedManyWithoutCreatorInputObjectSchema =
  Schema;
