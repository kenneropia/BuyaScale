...
const Schema: z.ZodType<Prisma.OrderUncheckedCreateNestedManyWithoutCreatorInput> =
  z
    .object({
      create: z
        .union([
...
export const OrderUncheckedCreateNestedManyWithoutCreatorInputObjectSchema =
  Schema;
