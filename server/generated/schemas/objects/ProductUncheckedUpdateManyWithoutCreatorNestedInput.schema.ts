...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutCreatorNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ProductUpdateManyWithWhereWithoutCreatorInputObjectSchema,
          ),
          z
            .lazy(
              () => ProductUpdateManyWithWhereWithoutCreatorInputObjectSchema,
...
export const ProductUncheckedUpdateManyWithoutCreatorNestedInputObjectSchema =
  Schema;
