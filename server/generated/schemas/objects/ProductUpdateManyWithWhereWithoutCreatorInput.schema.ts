...
const Schema: z.ZodType<Prisma.ProductUpdateManyWithWhereWithoutCreatorInput> =
  z
    .object({
...
export const ProductUpdateManyWithWhereWithoutCreatorInputObjectSchema = Schema;
