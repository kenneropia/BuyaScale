...
const Schema: z.ZodType<Prisma.ReviewUncheckedUpdateManyWithoutCreatorNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ReviewUpdateManyWithWhereWithoutCreatorInputObjectSchema,
          ),
          z
            .lazy(
              () => ReviewUpdateManyWithWhereWithoutCreatorInputObjectSchema,
...
export const ReviewUncheckedUpdateManyWithoutCreatorNestedInputObjectSchema =
  Schema;
