...
const Schema: z.ZodType<Prisma.ReviewUncheckedCreateNestedManyWithoutCreatorInput> =
  z
    .object({
      create: z
        .union([
...
export const ReviewUncheckedCreateNestedManyWithoutCreatorInputObjectSchema =
  Schema;
