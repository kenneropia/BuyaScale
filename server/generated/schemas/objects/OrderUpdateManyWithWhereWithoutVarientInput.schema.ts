...
const Schema: z.ZodType<Prisma.OrderUpdateManyWithWhereWithoutVarientInput> = z
  .object({
...
export const OrderUpdateManyWithWhereWithoutVarientInputObjectSchema = Schema;
