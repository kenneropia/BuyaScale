...
const Schema: z.ZodType<Prisma.ProductUpdateManyWithoutCategoryNestedInput> = z
  .object({
    create: z
      .union([
...
export const ProductUpdateManyWithoutCategoryNestedInputObjectSchema = Schema;
