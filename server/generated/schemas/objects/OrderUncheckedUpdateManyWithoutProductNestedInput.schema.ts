...
const Schema: z.ZodType<Prisma.OrderUncheckedUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => OrderUpsertWithWhereUniqueWithoutProductInputObjectSchema,
          ),
          z
            .lazy(
              () => OrderUpsertWithWhereUniqueWithoutProductInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => OrderUpdateWithWhereUniqueWithoutProductInputObjectSchema,
          ),
          z
            .lazy(
              () => OrderUpdateWithWhereUniqueWithoutProductInputObjectSchema,
...
export const OrderUncheckedUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
