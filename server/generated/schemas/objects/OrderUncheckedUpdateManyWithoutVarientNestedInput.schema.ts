...
const Schema: z.ZodType<Prisma.OrderUncheckedUpdateManyWithoutVarientNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => OrderUpsertWithWhereUniqueWithoutVarientInputObjectSchema,
          ),
          z
            .lazy(
              () => OrderUpsertWithWhereUniqueWithoutVarientInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => OrderUpdateWithWhereUniqueWithoutVarientInputObjectSchema,
          ),
          z
            .lazy(
              () => OrderUpdateWithWhereUniqueWithoutVarientInputObjectSchema,
...
export const OrderUncheckedUpdateManyWithoutVarientNestedInputObjectSchema =
  Schema;
