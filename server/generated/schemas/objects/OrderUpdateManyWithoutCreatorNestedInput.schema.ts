...
const Schema: z.ZodType<Prisma.OrderUpdateManyWithoutCreatorNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => OrderUpsertWithWhereUniqueWithoutCreatorInputObjectSchema),
        z
          .lazy(() => OrderUpsertWithWhereUniqueWithoutCreatorInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => OrderUpdateWithWhereUniqueWithoutCreatorInputObjectSchema),
        z
          .lazy(() => OrderUpdateWithWhereUniqueWithoutCreatorInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const OrderUpdateManyWithoutCreatorNestedInputObjectSchema = Schema;
