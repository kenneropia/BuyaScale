...
const Schema: z.ZodType<Prisma.CartUpdateManyWithoutCreatorNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => CartUpsertWithWhereUniqueWithoutCreatorInputObjectSchema),
        z
          .lazy(() => CartUpsertWithWhereUniqueWithoutCreatorInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => CartUpdateWithWhereUniqueWithoutCreatorInputObjectSchema),
        z
          .lazy(() => CartUpdateWithWhereUniqueWithoutCreatorInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const CartUpdateManyWithoutCreatorNestedInputObjectSchema = Schema;
