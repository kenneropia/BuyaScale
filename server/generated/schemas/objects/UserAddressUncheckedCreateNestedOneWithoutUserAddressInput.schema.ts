...
const Schema: z.ZodType<Prisma.UserAddressUncheckedCreateNestedOneWithoutUserAddressInput> =
  z
    .object({
      create: z
        .union([
...
export const UserAddressUncheckedCreateNestedOneWithoutUserAddressInputObjectSchema =
  Schema;
