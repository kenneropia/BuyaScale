...
const Schema: z.ZodType<Prisma.VarientUpdateManyWithoutProductNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => VarientUpdateManyWithWhereWithoutProductInputObjectSchema),
        z
          .lazy(() => VarientUpdateManyWithWhereWithoutProductInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const VarientUpdateManyWithoutProductNestedInputObjectSchema = Schema;
