...
const Schema: z.ZodType<Prisma.CartUpdateManyWithoutVarientNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => CartUpsertWithWhereUniqueWithoutVarientInputObjectSchema),
        z
          .lazy(() => CartUpsertWithWhereUniqueWithoutVarientInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => CartUpdateWithWhereUniqueWithoutVarientInputObjectSchema),
        z
          .lazy(() => CartUpdateWithWhereUniqueWithoutVarientInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const CartUpdateManyWithoutVarientNestedInputObjectSchema = Schema;
